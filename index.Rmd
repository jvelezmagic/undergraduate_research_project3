...
university-logo: figures/logos/unam.pdf
university-logo-width: 5cm
submitted-text: A thesis submitted for the degree of
degree: Bachelor of Science
degreedate: 'Cuernavaca, Morelos, Mexico - `r format(Sys.Date(), "%Y-%m")`'
abstract: |
...
output:
  ...
  bookdown::bs4_book: 
    ...
    theme:
      primary: "#274E82"
    repo: https://github.com/jvelezmagic/undergraduate_research_project
    pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  bookdown::gitbook:
