...
(ref:03-division-number-divisions-1-cap) **Cell's number of divisions.** Chromosomal cells exhibited more divisions for surviving classes and non-surviving filamented cells (_i.e._, purple, green, and red dots) relative to unchanged behavior in plasmid cells. Therefore, its contribution to filamentation remains uncertain.
...
(ref:03-see-datasets-individualy-pca-plasmid-points-in-new-coordinates-1-scap) Plasmid PCA.

(ref:03-see-datasets-individualy-pca-plasmid-points-in-new-coordinates-1-cap) **Plasmid PC**
...
(ref:03-see-datasets-individualy-pca-plasmid-variable-contribution-1-scap) Plasmid PCA variables contribution.

(ref:03-see-datasets-individualy-pca-plasmid-variable-contribution-1-cap) **Plasmid PCA variables contribution.**
...
(ref:03-see-datasets-individualy-umap-chromosome-points-in-new-coordinates-1-scap) UMAP of Chromosome experiment.

(ref:03-see-datasets-individualy-umap-chromosome-points-in-new-coordinates-1-cap) **UMAP of Chromosome experiment.**
...
(ref:3-see-datasets-individualy-umap-plasmid-points-in-new-coordinates-1-scap) UMAP of Plasmid experiment.

(ref:3-see-datasets-individualy-umap-plasmid-points-in-new-coordinates-1-cap) **UMAP of Plasmid experiment.**
...
(ref:03-temporal-metric-distribution-ds-red-1-cap) **DS-red temporal distribution.**
...
(ref:03-temporal-metric-distribution-gfp-1-cap) **GFP temporal distribution.**
...
(ref:03-temporal-metric-distribution-length-1-cap) **Length temporal distribution.**
...
(ref:03-time-to-filamentation-filamented-once-experiment-start-1-cap) **Time to filamentation filtered.**
...
(ref:03-time-to-filamentation-include-time-to-filamentation-in-initial-exploration-initial-values-1-scap) Experiment initial values with time.

(ref:03-time-to-filamentation-include-time-to-filamentation-in-initial-exploration-initial-values-1-cap) **Experiment initial values with time.**
...
(ref:04-metrics-over-time-1-cap) **Population measurements over time.**
...
(ref:04-length-survival-probability-1-scap) Plasmid initial GFP survival probability.

(ref:04-length-survival-probability-1-cap) **Plasmid initial GFP survival probability.**
...
(ref:04-gfp-survival-probability-1-scap) Plasmid initial length survival probability.

(ref:04-gfp-survival-probability-1-cap) **Plasmid initial length survival probability.**
