...
```{r include=FALSE, echo=FALSE}
survival_probability_scap <- "Effect of variability on the toxin-antitoxin system."
survival_probability_cap <- paste0(survival_probability_scap, " ", "The color of the heatmap is representative of the fraction of living cells at exposure time. The white vertical line represents the death time of the homogeneous population ($\\tau_{kill}$). At $t < \\tau_{kill}$, it is shown that the fraction of survivors decreases as the variability in the population increases. When $t = \\tau_{kill}$, the variability does not affect the fraction of survivors, but it represents a percentage improvement for the homogeneous population. Finally, when $t > \\tau_{kill}$, the heterogeneity of the population favors survival.")
```
  

```{r survival-probability, fig.align='center', echo=FALSE, out.width='100%', fig.pos='H', fig.cap=survival_probability_cap, fig.scap=survival_probability_scap}
if(knitr::is_html_output()){
  knitr::include_graphics("https://raw.githubusercontent.com/jvelezmagic/CellFilamentation/main/plots/r/model/survival_probability.png")
} else {
 linguisticsdown::include_graphics2("https://raw.githubusercontent.com/jvelezmagic/CellFilamentation/main/plots/r/model/survival_probability.pdf") 
}
```
