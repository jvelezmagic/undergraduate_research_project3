...
```{r filamentation-model-ramp-signal, fig.cap=filamentation_model_ramp_signal_cap, fig.scap="Effect of filamentation on intracellular toxin concentration."}
if(knitr::is_html_output()){
...
(ref:increased-time-resistance-cap) `r increased_time_resistance_cap`
(ref:increased-time-resistance-scap) `r increased_time_resistance_scap`
...
```{r variability-toxin-antitoxin, fig.cap=variability_toxin_antitoxin_cap, fig.scap=variability_toxin_antitoxin_scap}
...
```{r survival-probability, fig.cap=survival_probability_cap, fig.scap=survival_probability_scap}
