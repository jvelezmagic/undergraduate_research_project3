...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{downloadFigs4latex__main/03-cells-life-time-classes-distribution-1} \caption[Cells life time classes distribution.]{\textbf{Cells life time classes distribution.}}\label{fig:03-cells-life-time-classes-distribution-1}
\end{figure}
