...
\qauthor{--- George E.P. Box.}\end{savequote}



\hypertarget{rmd-basics}{%
\chapter{Models to the rescue; filamentation abstraction}\label{rmd-basics}}
